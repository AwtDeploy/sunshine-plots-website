          ...
          {items.map((it, i) => (
            <Reveal key={it.t} delay={i * 0.05}>
              <div className="group h-full rounded-2xl bg-white p-8 border border-border/60 hover:border-brand-green/40 hover:shadow-xl transition-all duration-500">
                <span className="inline-flex h-16 w-16 items-center justify-center rounded-2xl bg-brand-green/10 text-brand-green group-hover:bg-brand-green group-hover:text-white transition-colors">
